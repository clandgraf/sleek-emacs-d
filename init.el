...
(custom-set-variables
 ...
 '(package-selected-packages
   '(smartparens helm-projectile rjsx-mode diff-hl dracula-theme zenburn-theme monokai-pro-theme color-theme-sanityinc-solarized js2-mode processing-mode processing-snippets json-mode htmlize markdown-mode web-mode base16-theme rg rust-mode diminish smart-mode-line slime-company company projectile helm magit color-theme-sanityinc-tomorrow slime)))
(custom-set-faces
